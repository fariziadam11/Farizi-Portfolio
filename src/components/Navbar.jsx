        ...
        <div className="flex justify-between items-center">
          ...
          >
            <span className="flex items-center">
              <span className="relative">
                <span className="absolute -inset-1 -z-10 rounded-full bg-blue-500/20 blur-sm transition-all duration-300"></span>
                FA
              </span>
              <span className="ml-1 text-gray-800 dark:text-white transition-colors duration-300">Portfolio</span>
            </span>
          </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md focus:outline-none text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300"
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <motion.div className="relative">
              <motion.button 
                ...
                className={`relative p-2 rounded-full z-10 transition-all duration-300 ease-in-out ${
                  darkMode 
              ...
              >
                <motion.div
                  ...
                  initial={{ opacity: 0, rotate: darkMode ? 90 : -90, scale: 0.5 }}
                  animate={{ 
                    opacity: 1, 
                    rotate: 0,
                    scale: 1,
                ...
                >
                  {darkMode ? (
                    <Sun size={20} className="text-amber-300 transition-colors duration-300" />
                  ) : (
                    <Moon size={20} className="text-indigo-700 transition-colors duration-300" />
                  )}
                </motion.div>
              </motion.button>
              
              {/* Enhanced water droplet effect */}
              <motion.span 
              ...
              <div className="px-3 py-2 flex justify-between items-center border-t border-gray-200 dark:border-gray-700 mt-2 pt-2">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    >
                      {darkMode ? (
                        <Sun size={18} className="text-amber-300 transition-colors duration-300" />
                      ) : (
                        <Moon size={18} className="text-indigo-700 transition-colors duration-300" />
                      )}
                    </motion.div>
                  </motion.button>
                  
                  {/* Enhanced water droplet effect for mobile */}
                  <motion.span 
                    className="absolute inset-0 rounded-full pointer-events-none"
                    style={{
                      background: darkMode 
